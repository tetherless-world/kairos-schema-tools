...
@Singleton
class GraphQlController @Inject()(store: Store, system: ActorSystem, validators: Validators) extends BaseGraphQlController[GraphQlSchemaContext](GraphQlSchemaDefinition.schema, system) {
