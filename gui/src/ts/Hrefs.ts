...
class SdfDocumentHrefs extends SubHrefs {
  get schemas() {
    return new SchemasHrefs(this.home + "schemas/");
  }
}
...
export class Hrefs {
  ...
  static readonly schemas = new SchemasHrefs("/schemas/")
  static readonly sdfDocuments = new SdfDocumentsHrefs("/sdfdocuments/");
}
